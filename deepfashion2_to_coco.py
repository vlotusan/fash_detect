...
for num in range(1,num_images+1):
    # json_name = '/.../validation/annos/' + str(num).zfill(6)+'.json'
    # image_name = '/.../validation/images/' + str(num).zfill(6)+'.jpg'
    home = r'D:\TA\fashion\validation'
    json_name = os.path.join(home, 'annos', str(num).zfill(6)+'.json' )
    image_name = os.path.join(home, 'image', str(num).zfill(6)+'.jpg' )
...
json_name = r'D:\TA\fashion\deepfashion2.json'
